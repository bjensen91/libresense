<?php
/*
 * OpenSourceCompany_services_and_support.widget.php
 *
...
/*
	This widget transmits the OpenSourceCompany Device ID to OpenSourceCompany's REST API, and retrieves the support information.
...
$FQDN = "https://ews.OpenSourceCompany.com/support";
$refreshinterval = (24 * 3600);	// 24 hours


if ($_REQUEST['ajax']) {

	// Retrieve the support data from OpenSourceCompany.com if
...
print('<div style="text-align:right;padding-right:15px;"><a href="/widgets/widgets/OpenSourceCompany_services_and_support.widget.php?act=refresh" usepost><i class="fa fa-refresh"></i></a></div>');
...
//<![CDATA[
	events.push(function(){
		function fetch_spt_data() {
			...
			$.ajax({
				type: 'POST',
				url: "/widgets/widgets/OpenSourceCompany_services_and_support.widget.php",
				data: {
					ajax: "ajax"
				},

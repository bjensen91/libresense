...
if (count($argv) < 2) {
	...
	echo "be specified as your base libresense working directory.\n";
	echo "\n";
	echo "Examples:\n";
	echo "#generate-privdefs /\n";
	echo "#generate-privdefs /home/libresense/src/\n";
	echo "\n";
	exit -1;
}
...
$pdata .= " * Generated by libresense/tools/scripts/generate-privdefs.php\n";
$pdata .= " *\n";
$pdata .= " * ***************************************************\n";
